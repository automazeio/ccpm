...
- **created**: Run `date -u +"%Y-%m-%dT%H:%M:%SZ"` and use the result
...
- List specific missing sections if PRD is incomplete
- Identify what needs clarification if technical approach is unclear
- Decline to create the epic when information is insufficient
...
## Task Limits
- Limit total tasks to 10 or fewer.
- Identify ways to simplify. Leverage existing functionality before creating new code.
